...
<head>
    <meta charset="UTF-8">
    <title>Dashboard - MBG System</title>
    ...
    <style>
        ...
        .sidebar .nav-link { color: #003087; padding: 10px 15px; border-radius: 5px; margin: 2px 10px; font-weight: 400; }
...
<body>
    ...
    <div class="sidebar">
        <ul class="nav flex-column">
            ...
            <?php if ($role === 'gudang'): ?>
                <li class="nav-item">
                    <a class="nav-link" href="/bahan/tambahBahan">Tambah Bahan</a>
                </li>
            <?php elseif ($role === 'dapur'): ?>
                <li class="nav-item">
                    <a class="nav-link" href="#">Buat Permintaan</a>
                </li>
            <?php endif; ?>
        </ul>
    </div>
            ...
            <div class="col-md-4">
                <div class="card">
                    <div class="card-body text-center">
                        ...
                        <a href="#" class="btn btn-outline-success w-100">Lihat</a>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
